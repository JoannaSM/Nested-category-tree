...
class KategorieController extends Controller
{
	...
	public function actionIndex()
	{
		$dataProvider=new CActiveDataProvider('Category',array(
            'criteria'=>array(
                ...
                'group' => 't.id',
                'order'  => 't.lft',
                'condition'=>"t.lft BETWEEN parent.lft AND parent.rgt",
            ),
            'pagination'=>false,
        ));
	...
	/**
	 * Returns the data item based on the primary key given in the GET variable.
	 * If the data item is not found, an HTTP exception will be raised.
